                  ...
                  <div className="medicineGrid__wrapper">
                    <div className="medicineGrid__item">
                      ...
                      <div className="medicineGrid__item__info">
                        <h3 className="medicineGrid__item__title">{medicines[2]?.name}</h3>
                        <h3 className="medicineGrid__item__price">₹{medicines[2]?.stockDetails[0]?.price}</h3>
                    ...
                    <div className="medicineGrid__item">
                      ...
                      <div className="medicineGrid__item__info">
                        <h3 className="medicineGrid__item__title">{medicines[3]?.name}</h3>
                        <h3 className="medicineGrid__item__price">₹{medicines[3]?.stockDetails[0]?.price}</h3>
                        <div className="grid__wrapper">
                          <Link to="/cart" className="grid-button">
                            <button
                              className="primary-btn"
                    ...
                    <div className="medicineGrid__item">
                      ...
                      <div className="medicineGrid__item__info">
                        <h3 className="medicineGrid__item__title">{medicines[4]?.name}</h3>
                        <h3 className="medicineGrid__item__price">₹{medicines[4]?.stockDetails[0]?.price}</h3>
                        <div className="grid__wrapper">
                          <Link to="/cart" className="grid-button">
                            <button
                              className="primary-btn"
